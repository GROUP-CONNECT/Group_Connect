...
class Auth with ChangeNotifier {
  ...
  Future<void> doauthentication(BuildContext context) async {
    ...
    if (googleSignInAccount != null) {
      ...
      Fluttertoast.showToast(
          msg: 'Login to use the app!', toastLength: Toast.LENGTH_SHORT);
  }
  ...
  Future<void> authenticate(BuildContext context) async {
    if (kIsWeb) {
      ...
      if (connectionCheck == ConnectivityResult.mobile ||
          connectionCheck == ConnectivityResult.wifi) {
        doauthentication(context);
      } else
        Fluttertoast.showToast(
            msg: 'Turn on Mobile data or Wifi.',
            toastLength: Toast.LENGTH_SHORT);
    }
  }
